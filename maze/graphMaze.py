...
class GraphMaze(Maze):
    ...
    def initCells(self, addWallFlag:bool = True):
    ...
    def addWall(self, cell1:Coordinates, cell2:Coordinates)->bool:
        print(f"Attempting to add wall between: {cell1}, {cell2}")
    ...
    def removeWall(self, cell1:Coordinates, cell2:Coordinates)->bool:
        print(f"Attempting to remove wall between: {cell1}, {cell2}")
    ...
    # Check if coordinates are valid
        ...
        if self.m_graph.hasEdge(cell1, cell2):
            print("Cells are adjacent. Removing wall.")
            self.m_graph.updateWall(cell1, cell2, False)
            return True
        else:
            print("Cells are not adjacent. Cannot remove wall.")
            return False
